...
ActiveRecord::Schema[7.1].define(version: 2023_12_18_061359) do
  ...
  create_table "keywords", force: :cascade do |t|
    ...
    t.integer "total_link", default: 0, null: false
    t.bigint "total_result", default: 0, null: false
    t.integer "total_ad", default: 0, null: false
